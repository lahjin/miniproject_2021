...
<%
    ...
    ArrayList<Object> border = new Community_borderDAO().codeToBorder(Integer.parseInt(pageNo));
    ...
    <form action="" method="post">
        <div class="review_wrap">
            ...
            <div class="main_title">
                <input type="text" placeholder="제목을 입력하세요." id="cm_b_title" name="cm_b_title" value="<%=border.get(3)%>">
            </div>

            <div class="sub_title">
                <input type="text" placeholder="작품명을 입력하세요." id="cm_b_subTitle" name="cm_b_subTitle" value="<%=border.get(4)%>">
            </div>
            ...
            <div class="sub_wrap">
                ...
                <div class="main_write">
                    <textarea id="cm_b_content" name="cm_b_content" rows="10"><%=border.get(7)%></textarea>
                </div>
                ...
                <div class="numberBox">
                    <span>No.</span><input id="cm_b_code" type="text" name="cm_b_code" value="<%=border.get(0)%>" readonly>
                </div>
                <div class="button_box">
                    <input type="button" id="modal-write-post" value="수정">
...
<script>
    let selectGenre1 = "<%=border.get(5)%>";
    let selectGenre2 = "<%=border.get(6)%>";
    let selectOtt = "<%=border.get(2)%>";
    let selectStar = "<%=border.get(8)%>";
